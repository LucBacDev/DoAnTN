...
class Cart
{
    ...
    // add
    public function add($product, $quantity, $attribute_color_id,$attribute_size_id,$product_atb_id)
    {
        $item = [
            'id' => $product_atb_id,
            'name' => $product->name,
        ...
        if (isset($this->items[$product_atb_id])) {
            $this->items[$product_atb_id]['quantity'] += $quantity;
        } else {
